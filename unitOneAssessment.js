...
const numberOfDigits = (num) => String(num).length;
// Uncomment out the next line to test your solution
runQ2Tests()
...
const disemvowel = (str) => {
  ...
  for (let i = 0; i < strArr.length; i++) {
    if (strArr[i] === 'a' || strArr[i] === 'A' ||strArr[i] === 'i' ||strArr[i] === 'I' ||strArr[i] === 'o' ||
    strArr[i] === 'O' ||strArr[i] === 'u' ||strArr[i] === 'U' ||strArr[i] === 'e' ||strArr[i] === 'E') {
      continue;
    } else {
...
// Sample input:
// [{location: "Algeria", population: 41}, {location: "Belize", population: 0.4}, {location: "China", population: 1386}, 
// {location: "Denmark", population: 6}]

// Sample output:
// ["Algeria", "Belize", "China", "Denmark"]
const getLocations = (arr) => arr.map(obj => obj.location);
// Uncomment out the next line to test your solution
runQ5Tests()
...
// Write a function called onlyOddStrings that takes in an array of strings as input and returns an array that only includes 
// strings with an odd number of characters
// Your function should use a higher-ordered function (e.g map, filter, reduce, every, sort) in its implementation
const onlyOddStrings = (arr) => arr.filter(str => str.length % 2 === 1);
// Uncomment out the next line to test your solution
runQ6Tests()
...
//b.
// Make a function called getAllDayDescriptions that takes in an array of Day objects and returns an array of their descriptions. 
// Use a higher-ordered function (e.g map, filter, reduce, every, sort) in your implementation.
// The output should be in the same order as the input
class Day {
...
const getAllDayDescriptions = arr => {
  return arr.map(obj => obj.getDescription())
}
// Uncomment out the next line to test your solution
runQ7Tests()
